          ...
          vs-row(vs-type='flex')
            vs-col(vs-order="1", vs-justify="center", vs-align="center", vs-w="12", vs-lg="12", vs-sm="12").text-center
              ...
              vs-row(vs-justify='left').gallery
                vs-col(vs-type='flex', vs-justify='center', vs-align='center', vs-lg="4", vs-sm="12", v-for='(image, i) in project.image', :key='image.id')
                    ...
                    div(slot='footer')
                      vs-row(vs-justify='flex-end')
                        a(:href='image.url', :download='image.name')
                          vs-button.fa.fa-cloud-download(@click='downimage(image.name, image.url)', type='submit', vs-color='rgb(230,230,230)', vs-color-text='rgb(50,50,50)')
...
export default {
  ...
  methods: {
    clickPop(image) {
      console.log(image.activePhoto);
      return (image.activePhoto = true);
    },
    projectlist() {
